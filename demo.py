...
def parse_args():
    ...
    parser.add_argument('--path_to_vid', default='',
    ...
    parser.add_argument('-m', '--model', default='yolov7', type=str,
                        help='build yolo')
    parser.add_argument('-nc', '--num_classes', default=20, type=int,
                        help='number of classes.')
    parser.add_argument('--weight', default='F:/毕业设计/code/YOLO/weights/voc/yolov7/yolov7_best.pth',
...
def detect(args,
    ...
    # ------------------------- Video ---------------------------
        ...
        if args.gif:
            ...
            save_gif_name = os.path.join(save_gif_path, '{}.gif'.format(cur_time))
            print('generating GIF ...')
            imageio.mimsave(save_gif_name, image_list, duration=fps)
            print('GIF done: {}'.format(save_gif_name))

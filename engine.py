...
class Yolov8Trainer(object):
    def __init__(self, args, data_cfg, model_cfg, trans_cfg, device, model, criterion, world_size):
        ...
        self.lr_scheduler, self.lf = build_lr_scheduler(self.lr_schedule_dict, self.optimizer, 150)
    ...
    def train_one_epoch(self, model):
        ...
        for iter_i, (images, targets) in enumerate(self.train_loader):
            ...
            # 计算梯度
            self.scaler.scale(losses).requires_grad_(True)
    ...
    def rescale_image_targets(self, images, targets, stride, min_box_size, multi_scale_range=[0.5, 2.0]):
        """

...
class Yolov7PaFPN(nn.Module):
    def __init__(self,
        ...
        ## P4 -> P3
        self.reduce_layer_3 = Conv(round(256 * channel_width), round(128 * channel_width), k=1, norm_type=norm_type,
                                   act_type=act_type)
        ...
        # ----------------------------- Bottom-up FPN -----------------------------
        ## P3 -> P4
        self.downsample_layer_1 = DownSample(round(128 * channel_width), round(256 * channel_width), act_type,
                                             norm_type, depthwise)
        ...
        ## P4 -> P5
        self.downsample_layer_2 = DownSample(round(256 * channel_width), round(512 * channel_width), act_type,
                                             norm_type, depthwise)
        ...
        # ----------------------------- Output Proj -----------------------------
        ## Head convs
        self.head_conv_1 = Conv(round(128 * channel_width), round(256 * channel_width), k=3, s=1, p=1,
                                act_type=act_type, norm_type=norm_type)
        self.head_conv_2 = Conv(round(256 * channel_width), round(512 * channel_width), k=3, s=1, p=1,
                                act_type=act_type, norm_type=norm_type)
        self.head_conv_3 = Conv(round(512 * channel_width), round(1024 * channel_width), k=3, s=1, p=1,
                                act_type=act_type, norm_type=norm_type)
        ## Output projs

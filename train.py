...
def parse_args():
    ...
    parser.add_argument('--vis_aux_loss', action="store_true", default=True,
    ...
    parser.add_argument('--max_epoch', default=100, type=int,
                        help='max epoch.')
    parser.add_argument('--wp_epoch', default=3, type=int,
                        help='warmup epoch.')
    parser.add_argument('--eval_epoch', default=10, type=int, 
                        help='after eval epoch, the model is evaluated on val dataset.')
    parser.add_argument('--no_aug_epoch', default=3, type=int,
    ...
    parser.add_argument('-p', '--pretrained', default='weights/voc/yolov7/yolov7_best.pth', type=str,
                        help='load pretrained weight')
    parser.add_argument('-r', '--resume', default=None, type=str,
                        help='keep training')

    # Dataset
    parser.add_argument('--root', default='VOCtrainval_11-May-2012',
                        help='data root')
    ...
    parser.add_argument('--mixup', default=0.15, type=float,
    ...
    parser.add_argument('--dist_url', default='connect.bjc1.seetacloud.com',

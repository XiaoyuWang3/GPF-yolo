...
def parse_args():
    ...
    parser.add_argument('-m', '--model', default='yolov7', type=str,
                        help='build yolo')
    parser.add_argument('--weight', default='weights/voc/yolov7/yolov7_best.pth',
    ...
    # dataset
    parser.add_argument('--root', default='VOCtest_06-Nov-2007',
                        help='data root')
    ...
    # TTA
    parser.add_argument('-tta', '--test_aug', action='store_true', default=True,
